...
| Japanese                      | English                          |
| ----------------------------- | -------------------------------- |
| Kuruma wa ie no mae ni arimas | The car is in front of the house |
| Pabu no mae                   | In front of the pub              |
| Ie no naka                    | Inside the house                 |

## New grammar

1. To describe relative locations you use the current location and combine it with a direction.
2. For complex directions (such as down and then right) you use landmarks at each direction change.
