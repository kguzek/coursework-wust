...
int main()
{
    ...
    while (std::getline(std::cin, line) && line != "quit")
    {
        ...
        else if (command == "vars")
        {
            ...
            {
                std::cout << "nie można wypisać zmiennych przed wprowadzeniem wyrażenia" << std::endl;
            }
        }
        else if (command == "print")
        {
            ...
            {
                std::cout << "nie można wypisać drzewa przed wprowadzeniem wyrażenia" << std::endl;
            }
        }
        else if (command == "comp")
        {
            ...
            {
                std::cout << "nie można obliczyć wartości wyrażenia przed jego wprowadzeniem" << std::endl;
            }
        }
        else if (command == "join")
        {
            ...
            {
                std::cout << "nie można dołączyć do drzewa przed wprowadzeniem wyrażenia" << std::endl;
            }
        }
