...
int main()
{
  typedef Base256Number
    Base256NumberClass; // zastąp XYZ nazwą klasy `Base256Number`
  std::string (Base256Number::*toHexStringPtr)() const =
    &Base256NumberClass::to_hex_string;
